...
<head>
	...
	<style type="text/css">
		...
		table {
		    font-family: Garamond, serif; font-size: 10pt; font-weight: normal; font-style: normal;
		    border: none; padding: 0in; orphans: 2; widows: 2; margin-left: 0.025in
		}
		.footer {
            font-face: "Calibri Light, serif"; size: 8pt;
            line-height: 100%; margin-top: 0.17in; margin-bottom: 0in;
            background: #c0c0c0"
       }

        .career-summary {
			font-family: Garamond, serif; font-size: 11pt;
			line-height: 115%; orphans: 2; widows: 2; margin-top: 0.08in; margin-bottom: 0in
	    }
	</style>
</head>
